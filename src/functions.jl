...
function png_get_image_width(png_ptr::Ptr{Void}, info_ptr::Ptr{Void})
    ccall((:png_get_image_width, libpng), UInt32, (Ptr{Void}, Ptr{Void}), png_ptr, info_ptr)
end

function png_get_image_height(png_ptr::Ptr{Void}, info_ptr::Ptr{Void})
    ccall((:png_get_image_height, libpng), UInt32, (Ptr{Void}, Ptr{Void}), png_ptr, info_ptr)
end

function png_get_color_type(png_ptr::Ptr{Void}, info_ptr::Ptr{Void})
    ccall((:png_get_color_type, libpng), UInt32, (Ptr{Void}, Ptr{Void}), png_ptr, info_ptr)
end

function png_get_bit_depth(png_ptr::Ptr{Void}, info_ptr::Ptr{Void})
    ccall((:png_get_bit_depth, libpng), UInt32, (Ptr{Void}, Ptr{Void}), png_ptr, info_ptr)
end

function png_get_channels(png_ptr::Ptr{Void}, info_ptr::Ptr{Void})
    ccall((:png_get_channels, libpng), UInt8, (Ptr{Void}, Ptr{Void}), png_ptr, info_ptr)
end
