...
function png_init_io(png_ptr::Ptr{Cvoid}, fp::Ptr{Cvoid})
    ccall((:png_init_io, libpng), Cvoid, (Ptr{Cvoid}, Ptr{Cvoid}), png_ptr, fp)
end

function png_set_sig_bytes(png_ptr::Ptr{Cvoid})
    ccall((:png_set_sig_bytes, libpng), Cvoid, (Ptr{Cvoid}, Cint), png_ptr, PNG_BYTES_TO_CHECK)
end

function png_read_png(png_ptr::Ptr{Cvoid}, info_ptr::Ptr{Cvoid}, transforms::Int)
    ccall((:png_read_png, libpng), Cvoid, (Ptr{Cvoid}, Ptr{Cvoid}, Cint, Ptr{Cvoid}), png_ptr, info_ptr, transforms, C_NULL)
end
...
function png_destroy_read_struct(png_ptr::Ptr{Cvoid}, info_ptr::Ptr{Cvoid})
    ...
    ccall((:png_destroy_read_struct, libpng), Cvoid, (Ref{Ptr{Cvoid}}, Ref{Ptr{Cvoid}}, Ptr{Ptr{Cvoid}}), png_ptr_ptr, info_ptr_ptr, C_NULL)
end
...
function png_write_info(png_ptr::Ptr{Cvoid}, info_ptr::Ptr{Cvoid})
    ccall((:png_write_info, libpng), Cvoid, (Ptr{Cvoid}, Ptr{Cvoid}), png_ptr, info_ptr)
end

function png_destroy_write_struct(png_ptr::Ptr{Cvoid}, info_ptr::Ptr{Cvoid})
    png_ptr_ptr = Ref{Ptr{Cvoid}}(png_ptr)
    info_ptr_ptr = Ref{Ptr{Cvoid}}(info_ptr)
    ccall((:png_destroy_write_struct, libpng), Cvoid, (Ref{Ptr{Cvoid}}, Ref{Ptr{Cvoid}}), png_ptr_ptr, info_ptr_ptr)
end
